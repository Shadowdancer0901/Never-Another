...
val MeasurementpagePictures = listOf(
    CarouselItems(0, R.drawable.oevre_omkreds_front,"Picture 1 DKK",520.dp, 414.dp),
    CarouselItems(1, R.drawable.oevre_omkreds_ryg, "Picture 2 DKK", 520.dp, 414.dp),
    CarouselItems(2, R.drawable.nedre_omkreds_front, "Picture 3 DKK", 520.dp,414.dp),
    ...
    CarouselItems(5, R.drawable.bryst_hoejde, "Picture 6 DKK", 520.dp, 414.dp)
)
